...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    */
    ...
    shooter.flywheel.setDefaultCommand(new RunCommand(() -> shooter.flywheel.runWithOutputValue(operator.getTriggerAxis(Hand.kRight)), shooter.flywheel));
  ...
  private void configureButtonBindings() {
    ...
    operatorA.toggleWhenPressed(new RunCommand(() -> shooter.flywheel.setSpeed(11000)),true);  
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(
      new ParallelRaceGroup(
        new WaitCommand(4),
        new RunCommand(() -> shooter.flywheel.setSpeed(20000), shooter)
        ),
      new ParallelRaceGroup(
        new WaitCommand(8),
